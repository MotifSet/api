...
var zeroExOrderService_1 = require("../services/zeroExOrderService");
var takerWalletService_1 = require("../services/takerWalletService");
var PUBLIC_ADDRESS = constants_1.constants.PUBLIC_ADDRESS;
var OrderHandler = /** @class */ (function () {
    function OrderHandler(setProtocol, provider) {
        this.setProtocol = setProtocol;
        this.provider = provider;
        this.takerWalletService = new takerWalletService_1.TakerWalletService(provider);
        this.zeroExService = new zeroExOrderService_1.ZeroExOrderService(provider, setProtocol);
    }
    OrderHandler.prototype.getQuote = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, setAddress, quantity, setDetails, components, naturalUnit, ZERO_AMOUNT, E18, totalWeth, totalUSD, unitUSD, unitWeth, result;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = req.query, setAddress = _a.setAddress, quantity = _a.quantity;
    ...
    OrderHandler.prototype.postMarketOrder = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    OrderHandler.prototype.ensureAllowanceAndBalances = function (issuanceOrder) {
        return __awaiter(this, void 0, void 0, function () {
