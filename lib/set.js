        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, setProtocol.calculateSetUnitsAsync(componentAddresses, [new BigNumber_1.BigNumber(0.0001), new BigNumber_1.BigNumber(1)], // ZRX and KNC are $0.60 and $0.40, respectively
                        allocation, // Allocations passed in
                        new BigNumber_1.BigNumber(10))];
                case 1:
...
var initialAllocation = [new BigNumber_1.BigNumber(0.50), new BigNumber_1.BigNumber(0.50)];
