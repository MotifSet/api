...
var augurService_1 = require("./services/augurService");
...
var augur = new augurService_1.AugurConnection;
var app = express();
...
app.get('/augurCategories', function (req, res) { return augur.getCategoryData(req, res); });
app.get('/augurMarketData', function (req, res) { return augur.getMarketData(req, res); });
