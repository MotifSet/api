        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, setProtocol.calculateSetUnitsAsync(componentAddresses, [new utils_1.BigNumber(0.0001), new utils_1.BigNumber(1)], // ZRX and KNC are $0.60 and $0.40, respectively
                        allocation, // Allocations passed in
                        new utils_1.BigNumber(10))];
                case 1:
...
(function () { return __awaiter(_this, void 0, void 0, function () {
    var initialAllocation, initialSetAddress;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                initialAllocation = [new utils_1.BigNumber(0.50), new utils_1.BigNumber(0.50)];
                return [4 /*yield*/, createDEXSet(initialAllocation, 'S&P 500', 'SPY')];
            case 1:
                initialSetAddress = _a.sent();
